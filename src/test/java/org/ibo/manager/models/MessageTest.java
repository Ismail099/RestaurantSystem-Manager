...
class MessageTest {
    ...
    private void validateMessage( Message message, String receiver, String sender, String contents, boolean isSeen ) {
        ...
        assertEquals( isSeen, message.getSeen() );
    }
    ...
    void testManagerReadMessages() {
        ...
        for ( Message message : messages ) {
            assertEquals( message.getReceiver().equals( Util.CHAT_USER_MANAGER ), message.getSeen() ); // if the message is for the manager it should be read else it shouldn't
        }
    }
