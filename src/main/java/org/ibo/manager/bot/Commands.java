...
public class Commands {
    ...
    public static final String FREE_TABLES = COMMAND_PREFIX + "freetables";
    public static final String RESERVE = COMMAND_PREFIX + "reserve";
    public static final String ORDER = COMMAND_PREFIX + "order";
}
